    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link active" href="../penerbit/index.php">
                                <span data-feather="users" class="align-text-bottom"></span>
                                Data Penerbit
                            </a>
                        </li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <a href="frmAddPenerbit.php" <button class="btn btn-primary btn-sm">Tambah Data
                    Penebit</button></a>
                <br><br>
                    ...
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="frmUbahPenerbit.php?id_penerbit=<?php echo $rs['id_penerbit']; ?>"
                                        class="btn btn-warning btn-sm">Ubah</a>
                                    <a href="hapusPenerbit.php?id_penerbit=<?php echo $rs['id_penerbit']; ?>"
