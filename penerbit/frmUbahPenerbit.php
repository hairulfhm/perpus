...
$getData = mysqli_query($koneksi, "SELECT * FROM penerbit where id_penerbit='$idPenerbit'");
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Form Data Penerbit</h1>

                </div>
                <form action="simpanUbahPenerbit.php" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="" class="form-label">Nama Penerbit</label>
                            <input type="text" name="nama_penerbit" value="<?php echo $rs['nama_penerbit']; ?>"
                                class="form-control">
                            <input type="hidden" value="<?php echo $rs['id_penerbit']; ?>" name="id_penerbit">
                            <label for="" class="form-label">Alamat Penerbit</label>
                            <input type="text" name="alamat" value="<?php echo $rs['alamat']; ?>" class="form-control">
                            <br>
