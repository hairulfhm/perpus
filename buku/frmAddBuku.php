...
$getKode = mysqli_query($koneksi, "SELECT max(kd_buku) as kode from buku");
$rs = mysqli_fetch_array($getKode);
$hasil = $rs['kode'];
$noUrut = (int) substr($hasil, 3, 3);
$noUrut++;
$hurup = 'BK';
$kdBuku = $hurup . sprintf("%03s", $noUrut);
                ...
                <form action="simpanBuku.php" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" required name="judul_buku" class="form-control">
                            ...
                            <select name="id_penerbit" required class="form-select">
                                ...
                                ?>
                                <option value="<?php echo $rs['id_penerbit']; ?>"><?php echo $rs['nama_penerbit']; ?>
                                </option>
                                <?php
                                }
                                ?>
                            ...
                            <input type="text" required name="thn_terbit" class="form-control">
                            <br>
