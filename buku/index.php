...
$buku = mysqli_query($koneksi, "SELECT buku.*,penerbit.nama_penerbit  FROM buku INNER JOIN penerbit ON buku.id_penerbit=penerbit.id_penerbit");
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <!-- <h4>List Data Peminjaman Buku</h4> -->
                <a href="frmAddBuku.php" <button class="btn btn-primary btn-sm">Tambah Data
                    Buku</button></a>
                <br><br>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            ...
                            <?php
                            while ($rs = mysqli_fetch_array($buku)) {
                            ?>
                            <tr>
                                ...
                                <td><?php echo $rs['thn_terbit']; ?></td>
                                <td>
                                    <a href="frmUbahBuku.php?kd_buku=<?php echo $rs['kd_buku']; ?>"
                                        class="btn btn-warning btn-sm">Ubah</a>
                                    <a href="hapusBuku.php?kd_buku=<?php echo $rs['kd_buku']; ?>"
