...
$getKode = mysqli_query($koneksi, "SELECT max(kd_anggota) as kode from anggota");
$rs = mysqli_fetch_array($getKode);
$hasil = $rs['kode'];
$noUrut = (int) substr($hasil, 3, 3);
$noUrut++;
$hurup = 'ANG';
$noAnggota = $hurup . sprintf("%03s", $noUrut);
?>
<!doctype html>
<html lang="en">
