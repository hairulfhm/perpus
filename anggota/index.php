    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <a href="frmAddAnggota.php" <button class="btn btn-primary btn-sm">Tambah Data
                    Anggota</button></a>
                <br><br>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        <tbody>
                            <?php
                            while ($rs =  mysqli_fetch_array($anggota)) {
                            ?>
                            <tr>
                                ...
                                <td>
                                    <a href="frmUbahAnggota.php?kd_anggota=<?php echo $rs['kd_anggota']; ?>"
                                        class="btn btn-warning btn-sm">Ubah</a>
                                    <a href="hapusAnggota.php?kd_anggota=<?php echo $rs['kd_anggota']; ?>"
